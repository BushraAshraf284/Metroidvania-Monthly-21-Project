Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/21b1f1ac940458e4fbb97fa0f1a529bb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float blendStrength = (0.276 /*_RimBlendStrength*/);
				#ifdef POI_AUDIOLINK
				...
				#endif
				#if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
				float4 rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RimTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0.08082294,0,1,1).rgb, (0.0 /*_RimLightColorThemeIndex*/)), float4(0.08082294,0,1,1).a);
				#else
				float4 rimColor = float4(poiThemeColor(poiMods, float4(0.08082294,0,1,1).rgb, (0.0 /*_RimLightColorThemeIndex*/)), float4(0.08082294,0,1,1).a);
				#endif
				...
				float rim = 1 - smoothstep(min((0.25 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
				rim *= float4(0.08082294,0,1,1).a * rimColor.a * rimMask;
			...
			{
				float smoothness = (0.915 /*_MochieRoughnessMultiplier*/);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)), (1.38 /*_BumpScale*/));
