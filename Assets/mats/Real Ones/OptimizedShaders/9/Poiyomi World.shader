Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/edb74ded0023fd4479d1b2575d5ce33a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyVideoEffectsMainTex(inout float4 mainTexture, in PoiMesh poiMesh)
			{
				...
				if((0.0 /*_VideoPixelateToResolution*/))
				{
					...
					uvs = poiUV(uvs, float4(1,1,0.49,-0.74)) + _Time.x * float4(0,0,0,0);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, poiUV(mainUV, float4(1,1,0.49,-0.74)), float4(0,0,0,0), (0.0 /*_MainTexStochastic*/));
