Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/008a1d35d154a604aa238b64846b4c26"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float calculateCRTPixelBrightness(float2 uv)
			{
				...
				half electronBeamAlpha = frac(_Time.y * (30.0 /*_VideoCRTRefreshRate*/));
				...
				float CRTFrameTime = 1 / (30.0 /*_VideoCRTRefreshRate*/);
				float timeSincecurrentPixelWasHitByElectronBeam = (DistanceInPixelsFromCurrentElectronBeamPixel / totalPixels);
				return saturate((1.8 /*_VideoCRTPixelEnergizedTime*/) - timeSincecurrentPixelWasHitByElectronBeam);
			}
			void applyContrastSettings(inout float3 pixel)
			{
				...
				#endif
				pixel = saturate(lerp(half3(0.5, 0.5, 0.5), pixel, (3.0 /*_VideoContrast*/) + 1));
				#if !UNITY_COLORSPACE_GAMMA
			...
			{
				pixel = lerp(pixel.rgb, dot(pixel.rgb, float3(0.3, 0.59, 0.11)), -((0.76 /*_VideoSaturation*/)));
			}
