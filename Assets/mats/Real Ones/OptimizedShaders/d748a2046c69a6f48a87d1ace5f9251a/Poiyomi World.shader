Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/d748a2046c69a6f48a87d1ace5f9251a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.423 /*_MochieRoughnessMultiplier*/);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)), (0.34 /*_BumpScale*/));
