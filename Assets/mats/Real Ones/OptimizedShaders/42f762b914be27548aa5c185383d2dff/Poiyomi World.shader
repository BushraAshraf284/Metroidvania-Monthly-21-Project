Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi World/42f762b914be27548aa5c185383d2dff"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyContrastSettings(inout float3 pixel)
			{
				...
				#endif
				pixel = saturate(lerp(half3(0.5, 0.5, 0.5), pixel, (0.996 /*_VideoContrast*/) + 1));
				#if !UNITY_COLORSPACE_GAMMA
			...
			{
				pixel = lerp(pixel.rgb, dot(pixel.rgb, float3(0.3, 0.59, 0.11)), -((0.94 /*_VideoSaturation*/)));
			}
