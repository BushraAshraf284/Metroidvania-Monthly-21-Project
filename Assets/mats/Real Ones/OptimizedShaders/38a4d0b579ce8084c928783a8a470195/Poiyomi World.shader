Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/38a4d0b579ce8084c928783a8a470195"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				viewDotNormal = pow(viewDotNormal, (0.86 /*_RimPower*/));
				...
				float rimWidth = lerp( - .05, 1, (0.354 /*_RimWidth*/));
				float blendStrength = (0.465 /*_RimBlendStrength*/);
				#ifdef POI_AUDIOLINK
				...
				#endif
				#if defined(PROP_RIMTEX) || !defined(OPTIMIZER_ENABLED)
				float4 rimColor = POI2D_SAMPLER_PAN(_RimTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_RimTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(0.3572583,0,1,1).rgb, (0.0 /*_RimLightColorThemeIndex*/)), float4(0.3572583,0,1,1).a);
				#else
				float4 rimColor = float4(poiThemeColor(poiMods, float4(0.3572583,0,1,1).rgb, (0.0 /*_RimLightColorThemeIndex*/)), float4(0.3572583,0,1,1).a);
				#endif
				...
				float rim = 1 - smoothstep(min((0.102 /*_RimSharpness*/), rimWidth), rimWidth, viewDotNormal);
				rim *= float4(0.3572583,0,1,1).a * rimColor.a * rimMask;
				...
				finalRimColor *= (2.41 /*_RimBrightness*/);
			...
			{
				float smoothness = (0.671 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.407 /*_MochieMetallicMultiplier*/);
				...
				float3 reflCol = GetReflections(poiCam, poiLight, poiMesh, roughness, (0.0 /*_MochieForceFallback*/), (1.0 /*_MochieLitFallback*/), _MochieReflCube, poiCam.reflectionDir);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.517 /*_Cutoff*/));
