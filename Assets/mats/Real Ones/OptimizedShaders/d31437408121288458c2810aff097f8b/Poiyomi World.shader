Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/d31437408121288458c2810aff097f8b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.578 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.753 /*_MochieMetallicMultiplier*/);
				...
				specularMask *= (0.81 /*_MochieSpecularStrength*/);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)), (0.03 /*_BumpScale*/));
				...
				clip(poiFragData.alpha - (0.13 /*_Cutoff*/));
